    ...
    <section className="relative py-32 px-6 overflow-hidden bg-linear-to-b from-background via-muted/3 to-background">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-20">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-linear-to-br from-primary/5 to-primary/10 rounded-full border border-primary/10 backdrop-blur-sm mb-6">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="relative bg-linear-to-br from-card/90 to-card/60 backdrop-blur-xl rounded-3xl p-8 border border-border/50 hover:border-primary/30 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/10">
              <div className="space-y-6">
                ...
                <SignUpButton mode="modal">
                  <Button className="w-full py-3 bg-linear-to-br from-muted to-muted/80 text-foreground rounded-xl font-semibold">
                    Get Started Free
                  </Button>
                </SignUpButton>
          ...
          <div className="relative group">
            ...
            <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-20">
              <div className="bg-linear-to-br from-primary to-primary/80 text-primary-foreground px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                Most Popular
              </div>
            </div>
            ...
            <div className="relative bg-linear-to-br from-card/95 to-card/70 backdrop-blur-xl rounded-3xl p-8 border-2 border-primary/30 hover:border-primary/50 transition-all duration-500 shadow-xl hover:shadow-2xl hover:shadow-primary/20 scale-105">
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <div className="flex items-end gap-1">
                    <span className="text-4xl font-bold bg-linear-to-br from-primary to-primary/80 bg-clip-text text-transparent">
                      $9
                    </span>
                    <span className="text-muted-foreground mb-1">/month</span>
                  </div>
                ...
                <Button className="w-full py-3 bg-linear-to-br from-primary to-primary/90 hover:from-primary/95 hover:to-primary/85 text-primary-foreground rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
                  Start AI Basic
                </Button>
